...
class LogRMQService
{
    ...
    {
        $host = config('log-notice.log_rmq_connect.host');
        $port = config('log-notice.log_rmq_connect.port');
        $user = config('log-notice.log_rmq_connect.user');
        $pass = config('log-notice.log_rmq_connect.pass');
        $vhost = config('log-notice.log_rmq_connect.vhost');
